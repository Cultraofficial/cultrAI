...
tokenizer = AutoTokenizer.from_pretrained("gpt2", use_auth_token=HUGGINGFACE_TOKEN)
model = AutoModelForCausalLM.from_pretrained("gpt2", use_auth_token=HUGGINGFACE_TOKEN)
