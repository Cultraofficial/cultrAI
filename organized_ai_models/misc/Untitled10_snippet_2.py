...
# Create a simple sample script for testing
sample_script_content = """
print("Hello, Vertex AI! This is a test script.")
"""

with open("sample_script.py", "w") as script_file:
...
# Set up and deploy the sample job in Vertex AI
job = aiplatform.CustomJob.from_local_script(
    display_name="vertex-ai-deployment-job",
    script_path="sample_script.py",  # Now exists after creating it above
