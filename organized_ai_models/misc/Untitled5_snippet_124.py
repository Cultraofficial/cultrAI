...
# Authenticate using the specified service account key
...
# Define project ID explicitly based on past configuration
project_id = "your_actual_project_id"  # Ensure this matches your exact project ID
