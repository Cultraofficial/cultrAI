...
service_account_email = "github-workflow@gen-lang-client-0492208227.iam.gserviceaccount.com"
try:
    iam_client = storage_client._credentials.with_subject(service_account_email)
    print(f"Service account '{service_account_email}' is active and configured.")
except Exception as e:
    print("Failed to verify service account:", e)
