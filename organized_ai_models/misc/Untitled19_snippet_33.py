...
# Automatically detected service account key file path
SERVICE_ACCOUNT_FILE = "/content/drive/My Drive/BrandNewKey.json"  # Path to service account JSON
PROJECT_ID = "cultrai"
...
def authenticate_service():
    ...
    try:
        ...
        print(f"❌ Authentication failed. Reason: {e}")
        raise
